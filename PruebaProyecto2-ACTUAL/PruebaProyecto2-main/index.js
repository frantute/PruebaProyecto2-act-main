...
const connection = mysql.createConnection(process.env.DATABASE_URL = 'mysql://fgcxcabixqup9njsdnc1:pscale_pw_5NtL0Rfi1lDvuSofXsjNNvWw1Iwc7FkoLwcw5IqXo4H@aws.connect.psdb.cloud/pruebaproyecto1?ssl={"rejectUnauthorized":true}');
